...
public abstract class BasePage<T> {
    ...
    @FindBy(xpath="//body/div[2]/div[3]/div[2]/div[1]/div[2]/div[1]/div[2]")
    public WebElement logoutDropdown;

    @FindBy(xpath="//body/div[7]/div[1]/div[6]/div[1]")
    ...
    public T openPage(Class<T> clazz) {
        ...
        try {
          ...
          /*    String error_screenshot = System.getProperty("username.dir") + "\\target\\screenshots\\" + clazz.getSimpleName() + "_error.png";
    ...
    public void logout() {
        click(logoutDropdown, "Logout Dropdown Link");
        click(logout,"Logout Link");
    }
